...
// TODO: remove this function once ripple-alpha-core provides quality directly
...
// ripple-alpha-core 'account_offers' returns a different format for orders than 'tx'
...
export function parseAccountOrder(
  ...
  const specification = removeUndefined({
    ...
    // ripple-alpha-core currently does not provide "expiration" in account_offers
